...
{
private:
    const unsigned char pi_table[16][16] = {
    ...
    const unsigned char reverse_pi_table[16][16] = {
    ...
    const unsigned char const_raws[16] = {
        148, 32, 133, 16, 194, 192, 1, 251, 
        1, 192, 194, 16, 133, 32, 148, 1
    };
    unsigned char key_mod_consts[32][16];
    unsigned char round_keys[10][16];

    unsigned char key_initial_consts[512] = {
...
public:
    ...
    void X_operation(unsigned char* a, unsigned char* b);
    void S_operation(unsigned char* a);
    unsigned char Galua_Mult(unsigned char a, unsigned char b);
    void R_operation(unsigned char* a);
    void L_operation(unsigned char* a);
    
    void Feistel_operation(unsigned char* key_a, unsigned char* key_b, unsigned char* iter_const);

    unsigned char* Reverse_S_operation(unsigned char* a);
    void Reverse_R_operation(unsigned char* a);
    unsigned char* Reverse_L_operation(unsigned char* a);

    void generate_round_keys();
    void print_round_keys();

    void encript_simple(unsigned char* data);
    void encript_ECB(unsigned char* data, int size);
    void encript_CTR(unsigned char* data, unsigned char* IV, int size);
    void encript_OFB(unsigned char* data, unsigned char* IV, int size);
    void encript_CBC(unsigned char* data, unsigned char* IV, int size);
    void encript_CFB(unsigned char* data, unsigned char* IV, int size);


    unsigned char* decript(unsigned char* data, int size);
    bool saveHexToFile(const unsigned char* data, size_t size,
        const std::string& filename, bool append = false);
    void save_consts_to_files(const std::string& filename);
